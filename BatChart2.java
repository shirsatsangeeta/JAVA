...
values[0]=Integer(getParameter("values1"));
values[1]=Integer(getParameter("values2"));
values[2]=Integer(getParameter("values3"));
values[3]=Integer(getParameter("values4"));
}
...
g.fillRect(150,80+i*50,values[i].intValue(),40);
}
}
}
